...
Key 5 will activate Music mode! Music mode will load a sound file from the data/bin/ folder, and play the track.
This mode listens to the track and will make the particles move along with the beat, this works best with songs with lower tempos, but it still visibly reacts to faster music.


Team members:
Edgael De Jesus, edgael.dejesus@upr.edu
Edwin Camuy, edwin.camuy@upr.edu